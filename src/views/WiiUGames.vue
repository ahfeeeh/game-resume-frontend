...
export default {
  ...
  data() {
    return {      
      isLoading: true,
      newItem: {app_id: "", title: "", finished: null, fisical_disc: null, collection: null, genuine: null, table: 'wiiu'}      
    }
  },
  mounted() {
    setTimeout(() => {
  ...
  methods: {
    saveGame(payload) {  
      ...
      this.newItem = {app_id: "", title: "", finished: null, fisical_disc: null, collection: null, genuine: null, table: 'wiiu'}            
    }
  }
}
</script>
