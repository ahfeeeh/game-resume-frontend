  ...
  <div class="about">
    <h1>WiiU Games Table</h1>
     <div class="row align-items-end"  style="margin-top:20px">
        ...
        <div class="col"></div>
        <div class="col">
          <a type="button" class="btn btn-outline-primary" href="http://localhost:4000/csv?table=wiiu_games">to CSV</a> &nbsp;
          <a type="button" class="btn btn-outline-secondary" href="http://localhost:4000/pdf?from=wiiu">to PDF</a> &nbsp;
